...
@section('contenido')
    ...
    <form action="/admin/guardar" method="POST" class="max-w-md mx-auto" enctype="multipart/form-data">
        @csrf
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            <input name="imagen" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="imagen" id="imagen" type="file" required accept="image/*">
